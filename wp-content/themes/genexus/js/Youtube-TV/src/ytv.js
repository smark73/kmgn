...
(function(win, doc) {
	'use strict';
	var apiKey = 'AIzaSyD030kDq_Aeh9ltsKQ_tPzR1Yb4pT9spAo';
				...
				build: function(){
					...
					if(settings.responsive){
						utils.addCSS('#'+id+' .ytv-video{'
							+'position: relative; padding-bottom: 250px; /* 39.4%; 16:9 of 70%*/'
							+'height: 0; min-height: 250px; /*width: 70%;*/'
							+'} #'+id+' .ytv-video iframe{'
							...
							+'height: 0; min-height: 250px; position: relative;'
